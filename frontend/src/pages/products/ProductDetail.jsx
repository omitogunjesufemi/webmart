    ...
    <section className="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            ...
            <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                href="#"
                title=""
                className="text-white mt-4 sm:mt-0 bg-green-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center"
                role="button"
                >
                <svg
                    className="w-5 h-5 -ms-2 me-2"
